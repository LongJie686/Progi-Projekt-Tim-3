    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        ...
        <Link to="/admin/tutors">
          <Button variant={stats.pendingVerifications > 0 ? 'danger' : 'outline'}>
      ...
      <Card title="Quick Actions">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          ...
          <Link to="/admin/tutors">
            <Button variant="outline" fullWidth>Verify Tutors</Button>
          </Link>
          <Link to="/admin/audit">
            <Button variant="outline" fullWidth>View Audit Logs</Button>
          </Link>
          <Link to="/instructors">
            <Button variant="outline" fullWidth>View Platform</Button>
          </Link>
        </div>
      </Card>
    </div>
